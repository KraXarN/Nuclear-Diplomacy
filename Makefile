...
ND_Game-Linux-Debug:
	 $(PROJECTBUILD) ND_Game Linux Debug  -project="\"$(GAMEPROJECTFILE)\"" $(ARGS)

ND_Game-Linux-DebugGame:
	 $(PROJECTBUILD) ND_Game Linux DebugGame  -project="\"$(GAMEPROJECTFILE)\"" $(ARGS)

ND_Game-Linux-Shipping:
	 $(PROJECTBUILD) ND_Game Linux Shipping  -project="\"$(GAMEPROJECTFILE)\"" $(ARGS)

ND_Game-Linux-Test:
	 $(PROJECTBUILD) ND_Game Linux Test  -project="\"$(GAMEPROJECTFILE)\"" $(ARGS)

ND_Game:
	 $(PROJECTBUILD) ND_Game Linux Development  -project="\"$(GAMEPROJECTFILE)\"" $(ARGS)

ND_GameEditor-Linux-Debug:
	 $(PROJECTBUILD) ND_GameEditor Linux Debug  -project="\"$(GAMEPROJECTFILE)\"" $(ARGS)

ND_GameEditor-Linux-DebugGame:
	 $(PROJECTBUILD) ND_GameEditor Linux DebugGame  -project="\"$(GAMEPROJECTFILE)\"" $(ARGS)

ND_GameEditor-Linux-Shipping:
	 $(PROJECTBUILD) ND_GameEditor Linux Shipping  -project="\"$(GAMEPROJECTFILE)\"" $(ARGS)

ND_GameEditor-Linux-Test:
	 $(PROJECTBUILD) ND_GameEditor Linux Test  -project="\"$(GAMEPROJECTFILE)\"" $(ARGS)

ND_GameEditor:
	 $(PROJECTBUILD) ND_GameEditor Linux Development  -project="\"$(GAMEPROJECTFILE)\"" $(ARGS)

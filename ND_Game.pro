...
ND_GameRootPath=/home/kraxarn/Documents/Unreal Projects/ND_Game

gameProjectFile=/home/kraxarn/Documents/Unreal Projects/ND_Game/ND_Game.uproject
build=mono $$unrealRootPath/Engine/Binaries/DotNET/UnrealBuildTool.exe

args=$(ARGS)

include(ND_GameSource.pri)
include(ND_GameHeader.pri)
include(ND_GameConfig.pri)
include(ND_GameIncludes.pri)
include(ND_GameDefines.pri)
...
ND_Game-Linux-Debug.commands = $$build  -project="\"$$gameProjectFile\"" ND_Game Linux Debug $$args
ND_Game-Linux-DebugGame.commands = $$build  -project="\"$$gameProjectFile\"" ND_Game Linux DebugGame $$args
ND_Game-Linux-Shipping.commands = $$build  -project="\"$$gameProjectFile\"" ND_Game Linux Shipping $$args
ND_Game-Linux-Test.commands = $$build  -project="\"$$gameProjectFile\"" ND_Game Linux Test $$args
ND_Game.commands = $$build  -project="\"$$gameProjectFile\"" ND_Game Linux Development $$args

ND_GameEditor-Linux-Debug.commands = $$build  -project="\"$$gameProjectFile\"" ND_GameEditor Linux Debug $$args
ND_GameEditor-Linux-DebugGame.commands = $$build  -project="\"$$gameProjectFile\"" ND_GameEditor Linux DebugGame $$args
ND_GameEditor-Linux-Shipping.commands = $$build  -project="\"$$gameProjectFile\"" ND_GameEditor Linux Shipping $$args
ND_GameEditor-Linux-Test.commands = $$build  -project="\"$$gameProjectFile\"" ND_GameEditor Linux Test $$args
ND_GameEditor.commands = $$build  -project="\"$$gameProjectFile\"" ND_GameEditor Linux Development $$args
...
QMAKE_EXTRA_TARGETS += \ 
	...
	ND_Game-Linux-Debug \
	ND_Game-Linux-DebugGame \
	ND_Game-Linux-Shipping \
	ND_Game-Linux-Test \
	ND_Game \
	ND_GameEditor-Linux-Debug \
	ND_GameEditor-Linux-DebugGame \
	ND_GameEditor-Linux-Shipping \
	ND_GameEditor-Linux-Test \
	ND_GameEditor \
